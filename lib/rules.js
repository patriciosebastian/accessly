...
import { getEffectiveBackgroundColor, getEffectiveColor, parseClassStyles } from './helper.js'
...
const rules = [
  ...
  },
  {
    ...
    check: (document) => {
      ...
      // Step 2: Find all elements with either inline styles or class attributes
      const elements = findAll((el) => el.attribs?.style || el.attribs?.class, document.children);
